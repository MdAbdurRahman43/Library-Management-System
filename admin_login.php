...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql_query="SELECT * FROM admin_table WHERE admin_email='$admin_email';";
  ...
  $sql_query="SELECT * FROM admin_table WHERE admin_password='$admin_password';";
  $result=mysqli_query($con,$sql_query);
  if (mysqli_num_rows($result)>0) {
   $passErr=" ";
  ...
  $sql_query="SELECT * FROM admin_table WHERE admin_email='$admin_email' AND admin_password='$admin_password';";
  $result=mysqli_query($con,$sql_query);
  if (mysqli_num_rows($result)>0) {
